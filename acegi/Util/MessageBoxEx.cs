...
public class MessageBoxEx
{
    ...
    internal static void Show(UsuarioDAO usuarioDAO, string message, string v, MessageBoxButtons oK, MessageBoxIcon error)
    {
        //
    }
...
#pragma warning disable CS0618 // O tipo ou membro é obsoleto
            _hHook = SetWindowsHookEx(WH_CALLWNDPROCRET, _hookProc, IntPtr.Zero, threadId: AppDomain.GetCurrentThreadId());
